<?php 
    ...
    $firstname = $lastname = $zip_code = $town = $state = $phone = $company_name = $street = "";
    $firstName = $lastName = "";
    if(isset($_SESSION['id'])):
        ...
        if(isset($_POST['submit'])):
            ...
            if(count($errors) == 0):
                ...
                if(is_array($row)):
                    $sql = "UPDATE billing SET firstname='$firstname', email='$email', lastname='$lastname', state='$state', street='$street', phone='$phone', company_name='$company_name', town='$town', zipcode='$zip_code' WHERE customer_id='$customer_id' LIMIT 1";
                    ...
                    $sql = "INSERT INTO billing (customer_id, email, firstname, lastname, zipcode, state, town, company_name, phone, street) VALUES ('$customer_id', '$email', '$firstname', '$lastname', '$zip_code', '$state', '$town', '$company_name', '$phone', '$street')";
                ...
                <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    <form method="post" style="padding-top:10px;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="row" style="margin-top:20px;">
                            <div class="col">
                                <label for="" style="font-weight:bold;font-size:14px;">Phone <span style="color:red;">*</span></label>
                                <input type="text" class="form-control form-control-border" name="phone" value="<?=$phone?>">
                            </div>
                            <div class="col">
                                <label for="" style="font-weight:bold;font-size:14px;">Email address <span style="color:red;">*</span></label>
                                <input type="email" class="form-control form-control-border" name="email" value="<?php
                                    if(isset($email)):
                                        echo $email;
                                    else:
                                        echo $customer_email;
