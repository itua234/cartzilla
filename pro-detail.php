                                        ...
                                        while($array = $row->fetch_array()):
                                            ?>
												...
												<div class="item-slick3" data-thumb="images/product-03.jpg">
                                                    <div class="wrap-pic-w pos-relative">
                                                        <img class="w-full" src="images/product-03.jpg" alt="IMG-PRODUCT">
								...
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<div class="p-b-30 m-lr-15-sm">
										...
										<form class="w-full" action="" method="post">
											...
											<button type="submit" name="submit_review" class="submit_review flex-c-m stext-101 cl0 size-112 bg7 bor11 hov-btn3 p-lr-15 trans-04 m-b-10">
												Submit
											</button>
										</form>
									</div>
